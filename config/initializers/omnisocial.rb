Omnisocial.setup do |config|
  ...
  if Rails.env.production?
    ...
    config.facebook 'ad49c397eebb9581b3f0a189792ac486', '71d1b7dfd4c607b314fec33a91833c95', :scope => ['publish_stream', 'friends_birthdays', 'friends_email', 'friends_location']
